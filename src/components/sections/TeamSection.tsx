...
const teamMembers = [
  {
    ...
    bio: 'Nilesh Peswani is a forward-thinking technology executive with over 20 years of experience designing and delivering impactful software solutions that drive innovation, streamline operations, and fuel enterprise growth. With deep expertise in modern platforms and technologies, he has led high-stakes initiatives across U.S. Government contracting, technology, manufacturing, property management, and financial services sectors. An expert in ERP strategy, enterprise integration, technology master data governance, and compliance-driven transformation, Nilesh has consistently executed scalable, future-ready solutions that enhance automation, ensure audit integrity, and deliver long-term operational efficiency. His talent for aligning emerging technologies with core business goals has accelerated digital transformation and enabled enduring performance improvements. Recognized for his leadership in cloud architecture, intelligent automation, and compliance-first financial systems, Nilesh has guided enterprises through complex modernization efforts—balancing innovation with robust security, scalability, and regulatory adherence. A respected voice in U.S. Government contract accounting, enterprise technology leadership, and strategic consulting, Nilesh brings a unique combination of technical depth and visionary thinking. His track record proves that when harnessed strategically, technology becomes a catalyst for sustainable competitive advantage.',
    image: nilesh,
